...
class TestFixtureElGamal : public ::testing::Test {
  protected:
    ...
    const std::vector<Mpz> expected_ciphertext_output = {Mpz("236154725924767980551150673330103777948241812238232918563860"), Mpz("334914684833931523417345434823773865877240498516797745945354")};
...
// Decode test
TEST_F(TestFixtureElGamal, Decode) { EXPECT_FALSE(CryptoBase::decimal_to_english(plaintext_input).empty()); }
